...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public ApiResponse<AppointmentResponse> createAppointment(
        ...
        return ApiResponse.<AppointmentResponse>builder()
                ...
                .data(appointmentMapper.toResponse(savedAppointment))
                .build();
    }
    ...
    public ApiResponse<PageResponse<AppointmentResponse>> getAllAppointments(
        ...
        Page<Appointment> appointmentPage =
                appointmentRepository.findByDeletedAtIsNull(pageable);
    ...
    public ApiResponse<PageResponse<AppointmentResponse>> getDoctorAppointments(
        ...
        doctorRepository.findByIdAndDeletedAtIsNull(doctorId)
                .orElseThrow(() ->
        ...
        Page<Appointment> appointmentPage =
                appointmentRepository.findByDoctorIdAndDeletedAtIsNull(
                        doctorId,
                        pageable
                );
    ...
    public ApiResponse<PageResponse<AppointmentResponse>> getPatientAppointments(
        ...
        patientRepository.findByIdAndDeletedAtIsNull(patientId)
                .orElseThrow(() ->
        ...
        Page<Appointment> appointmentPage =
                appointmentRepository.findByPatientIdAndDeletedAtIsNull(
                        patientId,
                        pageable
                );
    ...
    @Override
    public ApiResponse<String> restoreAppointment(Long appointmentId) {
