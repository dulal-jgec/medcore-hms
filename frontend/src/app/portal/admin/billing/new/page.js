...
export default function NewAccountantPage() {
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      setServerError(
        error.message || "Failed to create accountant."
      );
    }
  }
        ...
        >
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-border bg-muted/20 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-muted-foreground">
                MedCore will automatically create the user
                account, generate a temporary password, and
                send the login credentials to the accountant's
                email address.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-start gap-3 rounded-xl border border-brand/20 bg-brand-soft/30 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-muted-foreground">
                This accountant will automatically belong to
                your current hospital. Hospital selection is
                controlled by the system and cannot be changed
                from this form.
              </p>
            </div>
          </div>
